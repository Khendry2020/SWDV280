<div class="container pb-5">
    ...
    <div class="container row p-3 color-orange color-light">
        ...
        <div class="col-md-6 col-12"><img src="./favicon/android-chrome-512x512.png" class="img-fluid rounded p-1"></div>
        <div class="col-md-6 col-12"><img src="./favicon/android-chrome-512x512.png" class="img-fluid rounded p-1"></div>
        <div class="col-md-6 col-12">
