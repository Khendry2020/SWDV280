...
$availables = availableFunitureLivingRoom();
			...
			<div class="row">
				<div class="col">
					...
					<div class="text-center pt-1 ">
						<h3 class="pt-1">Available Funiture: Living Room</h3>
						...
						<?php include './modules/availblelinks.php' ?>
							...
							<?php foreach ($availables as $LivingRoom) : ?>
								<tr>
									<td><?php echo $LivingRoom['Name']; ?></td>
                                    <td><?php echo $LivingRoom['Description']; ?></td>
									<td>$<?php echo number_format($LivingRoom['Price'], 2); ?></td>
								</tr>
							<?php endforeach; ?>
