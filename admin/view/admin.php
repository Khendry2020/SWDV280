...
<a href="<?php echo $app_path . 'controller' . '?action=view_products'; ?>">View Products</a>
<a href="<?php echo $app_path . 'controller' . '?action=view_categories'; ?>">View Categories</a>
<a href="<?php echo $app_path . 'controller' . '?action=view_users'; ?>">View Users</a>
<a href="<?php echo $app_path . 'controller' . '?action=view_reports'; ?>">View Reports</a>